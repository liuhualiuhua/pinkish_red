...
.STYLE6 {font-size: large; font-weight: bold; color: #FF0000; }
.STYLE8 {
	font-size: small;
	color: #66CCCC;
}
...
<table width="88%" height="73" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
  <tr>
    <td width="41%" height="38" align="center" bgcolor="#666666"><span class="STYLE2">标题</span></td>
    <td width="59%" align="center" bgcolor="#999999"><span  class="STYLE6">发布时间</span></td>
  </tr>
     <%  
       int newsId=Integer.parseInt(request.getParameter("newsId"));
       NewsDao newsDao=new NewsDaoImpl();
       
       int count1=newsDao.findCountNews(newsId);
    ...
    <%
      List list=newsDao.findListNews(pages);
      for(int i=0;i<list.size();i++){
         News news=(News)list.get(i);  
      %> 
  <tr>
       <td height="20" align="center"><a href="xinwenneiron.jsp?newsId=<%=news.getNewsId()%>" class="STYLE3  STYLE7"><%=news.getTitle() %></a></td>
    <td align="center" bgcolor="#00FFCC"><span class="STYLE4"><%=news.getPostTime() %></span></td>
  </tr>
  <%} %>
     <%
     News news=new News();
