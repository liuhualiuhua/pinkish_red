...
<head>
 ...
 .ceshi2{margin:0 auto;width:720px;border:1px solid;text-align:left;}
    </style>
	<script>
        ...
        <div class="top-info">
            <div class="top-left">
         	  ...
         	  Users users=(Users)session.getAttribute("user");
                if(users==null){
                  %>
                 out.print("<script>alert('您尚未登录 请先登录');location.href='pinhongdenglu.jsp'</script>");
                    <%
        	   }else{
...
<did class="ceshi2"><img src="img/11.png" width="1120" height="150"></img></div>

<%

   TopicDao topicdao=new TopicDaoImpl();
  Topic topic=(Topic)topicdao.findTopics(0);
  
 %>
<form action="dofatie.jsp?replyId=<%=topic.getReplyId() %>" method="post">
<table width="92%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="143" colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td width="25%" rowspan="3"><img src="img/dynamic1.jpg" width="293" height="279"></td>
    <td width="13%" height="61" align="center" valign="middle"><span class="STYLE26">标题</span></td>
    <td width="62%"><input name="title" type="text"></td>
  </tr>
  <tr>
    <td height="104" align="center" valign="middle"><span class="STYLE24"><br>内容</span></td>
    <td><textarea name="content1" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
    <input name="userId" type="hidden" value="" ><br>
    <input name="replyId" type="hidden" value="" ><br>
    <input name="postTime" type="hidden" value="" ><br>  
    </td>
  </tr>
      <tr>
      <td align="center" valign="middle">
     <input name="" type="submit" value="确认发帖"><input name="" type="reset" value="清空内容">
     </td>
     </tr>
</table>
</form>
